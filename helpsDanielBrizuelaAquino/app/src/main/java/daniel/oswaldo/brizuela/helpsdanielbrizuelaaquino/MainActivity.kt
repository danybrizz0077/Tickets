    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegistrar.setOnClickListener {
            ...
            if(nombre.isEmpty() || contra.isEmpty()){
                Toast.makeText(this, "Para seguir debe llenar todos los datos",
                    Toast.LENGTH_SHORT).show()
            }
            else {
                Log.i("Teste de credenciales",
        ...
        btnRegistrar.setOnClickListener {
            GlobalScope.launch(Dispatchers.IO) {
                ...
                val addUsuario = objConexion?.prepareStatement( "insert into Usuario (UUID_Usuario,Nombre_Usuario,Contrasena_Usuario) values(?,?,?)")!!
